#!/bin/bash
#SBATCH --job-name=lt_d4
#SBATCH --output=lt_d4_%j.out
#SBATCH --error=lt_d4_%j.err
...
srun python3 -u linktransformer_ccer_searchD4.py
# Tip: watch live progress with:  tail -f lt_d4_*.out
