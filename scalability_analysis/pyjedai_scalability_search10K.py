...
WORKER = os.path.join(os.path.dirname(os.path.abspath(__file__)),
                      "pyjedai_scalability_worker10K.py")
...
def main():
    ...
    print(f"pyJedAI scalability search (10K tuning) | dataset={DATASET} | B={B} | "
