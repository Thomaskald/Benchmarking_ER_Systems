#!/bin/bash
#SBATCH --job-name=pyjedai_scale_10k
#SBATCH --output=pyjedai_scale_10k_%j.out
#SBATCH --error=pyjedai_scale_10k_%j.err
...
srun python3 -u pyjedai_scalability_search10K.py
