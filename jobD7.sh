#!/bin/bash
#SBATCH --job-name=lt_d7
#SBATCH --output=lt_d7_%j.out
#SBATCH --error=lt_d7_%j.err
...
srun python3 -u linktransformer_ccer_searchD7.py
# Tip: watch live progress with:  tail -f lt_d7_*.out
