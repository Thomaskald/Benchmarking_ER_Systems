#!/usr/bin/env python3
"""
Best-config eval for D4: pairwise + cluster-level B-cubed.
Retrains the max-test_f1 config in results/linktransformer_D4_configs.csv.
...
SUMMARY_CSV = os.path.join(RESULTS_DIR, "linktransformer_bestconfig_evalD4.csv")
...
CFG = dict(
    sep='%',
    col_map=None,
    d1='/home/it2022025/er_scalability/datasets/D4/dblp.csv',
    d2='/home/it2022025/er_scalability/datasets/D4/acm.csv',
    text=[('title', 'text'), ('authors', 'text'), ('venue', 'text')],
    train='/home/it2022025/er_scalability/train_validation_test_sets/db4/train_set.csv',
    valid='/home/it2022025/er_scalability/train_validation_test_sets/db4/valid_set.csv',
    test='/home/it2022025/er_scalability/train_validation_test_sets/db4/test_set.csv',
    gt='/home/it2022025/er_scalability/datasets/D4/gt.csv',
    gt_sep='%',
    gt_header=0,
)
...
def read_best_config():
    """(params, config_id, csv_test_f1) for the max-test_f1 OK row of D4."""
