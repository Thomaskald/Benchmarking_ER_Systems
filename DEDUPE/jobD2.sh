#!/bin/bash
#SBATCH --job-name=dedupe_d2
#SBATCH --output=dedupe_d2_%j.out
#SBATCH --error=dedupe_d2_%j.err
...
srun python3 -u dedupe_ccer_searchD2.py

# Tip: watch live progress with:  tail -f dedupe_d2_*.out
