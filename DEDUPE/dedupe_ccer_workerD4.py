...
D1_PATH    = "/home/it2022025/er_scalability/datasets/D4/acm.csv"   # left_id side
D2_PATH    = "/home/it2022025/er_scalability/datasets/D4/dblp.csv"  # right_id side
...
def load_csv(path):
    ...
    with open(path, encoding="utf-8-sig") as f:       # D4 uses utf-8-sig
        reader = csv.DictReader(f, delimiter="%")     # D4 uses %
        for row in reader:
            try:
