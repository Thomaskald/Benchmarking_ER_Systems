...
D1_PATH    = "/home/it2022025/er_scalability/datasets/D9/dblp.csv"     # left_id side
D2_PATH    = "/home/it2022025/er_scalability/datasets/D9/scholar.csv"  # right_id side
...
def load_csv(path):
    import csv
    data = {}
    with open(path, encoding="utf-8-sig") as f:       # D4 uses utf-8-sig
        reader = csv.DictReader(f, delimiter=">")     # D9 uses >
        for row in reader:
            try:
