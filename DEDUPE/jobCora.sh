#!/bin/bash
#SBATCH --job-name=dedupe_der_cora
#SBATCH --output=dedupe_der_cora_%j.out
#SBATCH --error=dedupe_der_cora_%j.err
...
srun python3 -u dedupe_der_searchCora.py

# Tip: watch live progress with:  tail -f dedupe_der_cora_*.out
