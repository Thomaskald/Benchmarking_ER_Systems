#!/usr/bin/env python3
"""
Best-config eval for D6: pairwise + cluster-level B-cubed.
Retrains the max-test_f1 config in results/linktransformer_D6_configs.csv.
...
SUMMARY_CSV = os.path.join(RESULTS_DIR, "linktransformer_bestconfig_evalD6.csv")
...
CFG = dict(
    ...
    d1='/home/it2022025/er_scalability/datasets/D6/imdb.csv',
    d2='/home/it2022025/er_scalability/datasets/D6/tvdb.csv',
    text=[('title', 'text'), ('name', 'text'), ('episodeNumber', 'numstr'), ('seasonNumber', 'numstr')],
    train='/home/it2022025/er_scalability/train_validation_test_sets/db6/train_set.csv',
    valid='/home/it2022025/er_scalability/train_validation_test_sets/db6/valid_set.csv',
    test='/home/it2022025/er_scalability/train_validation_test_sets/db6/test_set.csv',
    gt='/home/it2022025/er_scalability/datasets/D6/gt.csv',
    gt_sep='|',
    gt_header=0,
)
...
def read_best_config():
    """(params, config_id, csv_test_f1) for the max-test_f1 OK row of D6."""
