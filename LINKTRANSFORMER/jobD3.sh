#!/bin/bash
#SBATCH --job-name=lt_d3
#SBATCH --output=lt_d3_%j.out
#SBATCH --error=lt_d3_%j.err
...
srun python3 -u linktransformer_ccer_searchD3.py
# Tip: watch live progress with:  tail -f lt_d3_*.out
