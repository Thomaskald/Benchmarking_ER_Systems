#!/bin/bash
#SBATCH --job-name=lt_d2
#SBATCH --output=lt_d2_%j.out
#SBATCH --error=lt_d2_%j.err
...
srun python3 -u linktransformer_ccer_searchD2.py

# Tip: watch live progress with:  tail -f lt_d2_*.out
