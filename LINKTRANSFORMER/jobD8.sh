#!/bin/bash
#SBATCH --job-name=lt_d8
#SBATCH --output=lt_d8_%j.out
#SBATCH --error=lt_d8_%j.err
...
srun python3 -u linktransformer_ccer_searchD8.py
# Tip: watch live progress with:  tail -f lt_d8_*.out
