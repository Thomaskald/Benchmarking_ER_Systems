#!/bin/bash
#SBATCH --job-name=lt_d6
#SBATCH --output=lt_d6_%j.out
#SBATCH --error=lt_d6_%j.err
...
srun python3 -u linktransformer_ccer_searchD6.py
# Tip: watch live progress with:  tail -f lt_d6_*.out
