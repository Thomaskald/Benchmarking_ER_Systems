#!/bin/bash
#SBATCH --job-name=zingg_d2
#SBATCH --output=zingg_d2_%j.out
#SBATCH --error=zingg_d2_%j.err
...
srun python3 -u zingg_ccer_searchD2.py

# Tip: watch live progress with:  tail -f zingg_d2_*.out
