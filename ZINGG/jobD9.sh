#!/bin/bash
#SBATCH --job-name=zingg_d9
#SBATCH --output=zingg_d9_%j.out
#SBATCH --error=zingg_d9_%j.err
...
srun python3 -u zingg_ccer_searchD9.py
# Tip: watch live progress with:  tail -f zingg_d9_*.out
