#!/bin/bash
#SBATCH --job-name=zingg_d6
#SBATCH --output=zingg_d6_%j.out
#SBATCH --error=zingg_d6_%j.err
...
srun python3 -u zingg_ccer_searchD6.py
# Tip: watch live progress with:  tail -f zingg_d6_*.out
