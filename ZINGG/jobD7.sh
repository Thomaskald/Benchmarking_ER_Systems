#!/bin/bash
#SBATCH --job-name=zingg_d7
#SBATCH --output=zingg_d7_%j.out
#SBATCH --error=zingg_d7_%j.err
...
srun python3 -u zingg_ccer_searchD7.py
# Tip: watch live progress with:  tail -f zingg_d7_*.out
