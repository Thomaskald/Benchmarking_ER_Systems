#!/bin/bash
#SBATCH --job-name=zingg_der_cddb
#SBATCH --output=zingg_der_cddb_%j.out
#SBATCH --error=zingg_der_cddb_%j.err
...
srun python3 -u zingg_der_searchCDDB.py
# Tip: watch live progress with:  tail -f zingg_der_cddb_*.out
