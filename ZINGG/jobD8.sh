#!/bin/bash
#SBATCH --job-name=zingg_d8
#SBATCH --output=zingg_d8_%j.out
#SBATCH --error=zingg_d8_%j.err
...
srun python3 -u zingg_ccer_searchD8.py
# Tip: watch live progress with:  tail -f zingg_d8_*.out
