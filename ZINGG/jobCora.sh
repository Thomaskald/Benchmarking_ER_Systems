#!/bin/bash
#SBATCH --job-name=zingg_der_cora
#SBATCH --output=zingg_der_cora_%j.out
#SBATCH --error=zingg_der_cora_%j.err
...
srun python3 -u zingg_der_searchCora.py
# Tip: watch live progress with:  tail -f zingg_der_cora_*.out
