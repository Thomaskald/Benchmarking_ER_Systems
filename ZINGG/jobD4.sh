#!/bin/bash
#SBATCH --job-name=zingg_d4
#SBATCH --output=zingg_d4_%j.out
#SBATCH --error=zingg_d4_%j.err
...
srun python3 -u zingg_ccer_searchD4.py
# Tip: watch live progress with:  tail -f zingg_d4_*.out
