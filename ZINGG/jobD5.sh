#!/bin/bash
#SBATCH --job-name=zingg_d5
#SBATCH --output=zingg_d5_%j.out
#SBATCH --error=zingg_d5_%j.err
...
srun python3 -u zingg_ccer_searchD5.py
# Tip: watch live progress with:  tail -f zingg_d5_*.out
