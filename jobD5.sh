#!/bin/bash
#SBATCH --job-name=lt_d5
#SBATCH --output=lt_d5_%j.out
#SBATCH --error=lt_d5_%j.err
...
srun python3 -u linktransformer_ccer_searchD5.py
# Tip: watch live progress with:  tail -f lt_d5_*.out
