#!/bin/bash
#SBATCH --job-name=pyjedai_der_cora
#SBATCH --output=pyjedai_der_cora_%j.out
#SBATCH --error=pyjedai_der_cora_%j.err
...
srun python3 -u pyjedai_der_searchCora.py
# Tip: watch live progress with:  tail -f pyjedai_der_cora_*.out
