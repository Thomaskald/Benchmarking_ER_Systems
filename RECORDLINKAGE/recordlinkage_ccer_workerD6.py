...
def main():
    ...
    features_train = compare.compute(train_index, imdb, tvdb)
    features_valid = compare.compute(valid_index, imdb, tvdb)
    features_test = compare.compute(test_index, imdb, tvdb)
    ...
    for pidx, fdf in [(train_index, features_train), (valid_index, features_valid), (test_index, features_test)]:
        fdf["tfidf_word"] = build_tfidf_sim(pidx, imdb, tvdb, word_vec, ["title", "name"], "tfidf_word")
        fdf["tfidf_char"] = build_tfidf_sim(pidx, imdb, tvdb, char_vec, ["title", "name"], "tfidf_char")
