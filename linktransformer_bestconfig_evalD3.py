#!/usr/bin/env python3
"""
Best-config eval for D3: pairwise + cluster-level B-cubed.
Retrains the max-test_f1 config in results/linktransformer_D3_configs.csv.
...
SUMMARY_CSV = os.path.join(RESULTS_DIR, "linktransformer_bestconfig_evalD3.csv")
...
CFG = dict(
    sep='#',
    col_map=None,
    d1='/home/it2022025/er_scalability/datasets/D3/amazon.csv',
    d2='/home/it2022025/er_scalability/datasets/D3/gp.csv',
    text=[('title', 'text'), ('manufacturer', 'text'), ('description', 'text')],
    train='/home/it2022025/er_scalability/train_validation_test_sets/db3/train_set.csv',
    valid='/home/it2022025/er_scalability/train_validation_test_sets/db3/valid_set.csv',
    test='/home/it2022025/er_scalability/train_validation_test_sets/db3/test_set.csv',
    gt='/home/it2022025/er_scalability/datasets/D3/gt.csv',
    gt_sep='#',
    gt_header=0,
)
...
def read_best_config():
    """(params, config_id, csv_test_f1) for the max-test_f1 OK row of D3."""
